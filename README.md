...
<a href="documentation/images/before.png"><img src="documentation/images/before.png" width="48%" style="border:1px solid gray"></a>
<a href="documentation/images/after.png"><img src="documentation/images/after.png" width="48%" align="right" style="border:1px solid gray"></a> 
...
- November 2020: [First release](https://www.datamechanics.co/blog-post/were-releasing-a-free-cross-platform-spark-ui-and-spark-history-server). A Dashboard to track your apps with one-click access to a Hosted Spark History Server (Spark UI).
